        ...
        <main className="min-h-screen bg-stone-50 text-stone-900">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 space-y-6">
                ...
                {municipales.length > 0 && (
                    <button onClick={descargarTodas} className="flex items-center gap-2 rounded-xl bg-green-700 hover:bg-green-600 px-4 py-2 text-white text-sm font-semibold shadow-sm transition">
                        Descargar ZIP
                    </button>
                )}
                ...
                <div className="flex flex-wrap gap-6">
                    {municipales.map((m, idx) => (
                        <div key={idx} id={`tarjeta-municipal-${idx}`} className="bg-white text-stone-900 border border-stone-200 p-4 rounded-2xl shadow-sm w-[280px]">
